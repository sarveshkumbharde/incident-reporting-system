...
const Profile = () => {
  ...
  const reportedIncidentsList = reportedIncidents.length > 0 ? reportedIncidents : (user.reportedIncidents || []);
            ...
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
              ...
              <div className="text-center mb-6">
                <div className="relative inline-block">
                  ...
                  <div className={`absolute bottom-2 right-2 w-6 h-6 rounded-full border-2 border-white ${
                    ...
                    user.role === 'authority' ? 'bg-orange-500' : 'bg-green-500'
                  }`}></div>
                </div>
                ...
                <p className={`inline-block px-3 py-1 rounded-full text-sm font-medium mt-2 ${
                  ...
                  user.role === 'authority' ? 'bg-orange-100 text-orange-800' : 'bg-green-100 text-green-800'
                }`}>
              ...
              {/* <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                  <span className="text-sm font-medium text-blue-700">Reported Incidents</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <img src={user.aadharCard || 'Not provided'} className='w-[100px] h-[200px] mt-2' alt="" />
                  </div>
                </div>
              </div>
              ...
              {reportedIncidentsList.length > 0 ? (
                <div className="space-y-3">
                  {reportedIncidentsList.map((incident, index) => (
                    <div key={incident._id || index} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
